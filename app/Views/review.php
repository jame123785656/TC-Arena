...
<body>
    <nav class="navbar navbar-expand-lg navbar-drak fixed-top" style=" background-image: linear-gradient(white);; height:65px;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="nav justify-content-center">
                <li class="nav-item">
                    <a class="nav-link" href="/index" style="color: black;">หน้าหลัก</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#" style="color: black;">จองสนาม</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/review" style="color: black;">รีวิวสนาม</a>
                </li>
                <li class="nav-item">
        ...
        <a class="btn btn-outline-light mr-2" href="/login">เข้าสู่ระบบ</a>
    </nav>
    <br><br>
    <div class="container">
       <center> <h2 class="mt-5 mb-5">รีวิวสนาม</h2></center>
        <div class="card">
            <div class="card-body">
                <div class="row">
